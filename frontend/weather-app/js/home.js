...
function getTemp()
{
    ...
    (async()=>
    {
        ...
        document.getElementById("temp").innerHTML=parseFloat(dataJson[0].temperature).toFixed(2);
    })();
};
function getHumidOut()
{
    ...
    (async()=>
    {
        ...
        document.getElementById("humid_out").innerHTML=parseFloat(dataJson[0].humidity_out).toFixed(2)+"%";
    })();
}
function getHumidIn()
{
    ...
    (async()=>
    {
        ...
        console.log("?????",dataJson);
        console.log("=>",dataJson[0].humidity_out);
        document.getElementById("humid_in").innerHTML=parseFloat(dataJson[0].humidity_in).toFixed(2)+"%";
    })();
}
function getRain()
{
    ...
    (async()=>
    {
        ...
        document.getElementById("rain").innerHTML=parseFloat(dataJson[0].rain).toFixed(2)+"%";
    })();
}
function getSun()
{
    ...
    (async()=>
    {
        ...
        document.getElementById("sun").innerHTML=parseFloat(dataJson[0].light).toFixed(2)+"%";
    })();
}
function getWindSpeed()
{
    ...
    (async()=>
    {
        ...
        document.getElementById("wind_speed").innerHTML=parseFloat(dataJson[0].wind_speed).toFixed(2);
    })();
}
